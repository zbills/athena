...
```bash
python -m athena_eval.evaluate --model gpt-41-mini_0 --task RCM
```
...
```bash
python -m athena_eval.run --mini --model gpt-41-mini_0 --task RCM
```
```bash
python -m athena_eval.evaluate --mini --model gpt-41-mini_0 --task RCM
```
